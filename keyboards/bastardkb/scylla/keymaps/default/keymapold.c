...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_4x6_5(
                            ...
                            KC_LBRC, KC_A, KC_R, KC_S, KC_T, KC_G,		 KC_M, KC_N, KC_E, KC_I, KC_O, KC_MINS,
                            KC_RBRC, KC_Z, KC_X, KC_C, KC_D, KC_V,		 KC_K, KC_H, KC_COMM, KC_DOT, KC_SCLN, KC_SLSH,
    ...
    [1] = LAYOUT_split_4x6_5(
                            ...
                            KC_LBRC, KC_A, KC_S, KC_D, KC_F, KC_G,		 KC_H, KC_J, KC_K, KC_L, KC_QUOT, KC_RBRC,
                            KC_MINS, KC_Z, KC_X, KC_C, KC_V, KC_D,		 KC_N, KC_M, KC_COMM, KC_DOT, KC_SCLN, KC_SLSH,
    ...
    [2] = LAYOUT_split_4x6_5(
						KC_NO, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,		 			KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11,
                            ...
                            KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_DEL,		KC_NO, RALT(KC_Q), RALT(KC_W), RALT(KC_P), KC_NO, KC_NO,
